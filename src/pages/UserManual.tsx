  ...
  },
  {
    ...
    rawHtml: `
      ...
      <ul>
        ...
        <li><strong>Business Profile &amp; BIR Provider Info (Admin Only):</strong> Configure Business Name, Address, TIN, MIN, and PTU authority. Toggle VAT Registered. BIR Software Provider fields (Name: <em>Ceintelly Software Development Services</em>, Address, TIN, Accreditation No., Date Issued, Valid Until) are managed via hardcoded system constants (<code>SOFTWARE_PROVIDER_INFO</code>).</li>
        ...
        <li><strong>Receipt Printer Tab:</strong> Set up connection configs: USB (using WebUSB; requires Chrome/Edge) and Android Bluetooth (BLE). Click "Scan &amp; Pair Bluetooth Printer" or "Select &amp; Pair USB Printer" to open the device chooser, select your printer, pair, and connect. Toggle <strong>Auto-Print on Checkout</strong> to automatically send receipts to the printer after every successful sale.</li>
