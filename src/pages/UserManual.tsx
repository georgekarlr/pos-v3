  ...
  },
  {
    ...
    rawHtml: `
      ...
      <ul>
        ...
        <li><strong>Receipt Printer Tab:</strong> Set up connection configs: USB (using WebUSB; requires Chrome/Edge) and Android Bluetooth (BLE). Click "Scan &amp; Pair Bluetooth Printer" or "Select &amp; Pair USB Printer" to open the device chooser, select your printer, pair, and connect.</li>
