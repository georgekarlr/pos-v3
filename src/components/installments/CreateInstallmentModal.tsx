  ...
  const handleSubmit = async () => {
    ...
    const result = await onConfirm({
      ...
      p_cart_full: cartCalculations.calculatedLines.map(line => ({
        ...
        qty: line.qty,
        unitType: line.product.unit_type,
        lineTotal: line.displayLineTotal ?? (line.lineGross + line.lineTax),
        unitPrice: line.product.display_price,
        baseUnitPrice: line.product.base_price,
        promoDiscount: line.promoDiscount,
        promoId: line.promoId,
        vatExemptLineTotal: line.vatExemptLineTotal,
        taxType: line.product.tax_type,
        isScPwdEligible: line.product.is_sc_pwd_eligible,
      })),
