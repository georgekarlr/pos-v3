  ...
  return (
    <div className="space-y-4 text-sm text-gray-700">
      ...
      <ol className="list-decimal list-inside space-y-1 ml-2 text-xs">
        ...
        <li><strong>Confirm:</strong> Review the customer details, purchased items, applied discounts, calculated monthly due and interest rate before generating the contract. Every contract creation request includes a unique UUID <code>p_idempotency_key</code> to prevent duplicate contract generation during retries. Upon creation, an installment contract receipt is generated containing itemized products, contract terms, downpayment, and a BIR-compliant VAT Breakdown section (VATable Sales, 12% VAT Amount, VAT-Exempt Sales, and Zero-Rated Sales).</li>
      </ol>
