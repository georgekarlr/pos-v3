  ...
  return (
    <div className="space-y-4 text-sm text-gray-700">
      ...
      <ul className="list-disc list-inside space-y-1 ml-2">
        <li><strong>Receipt printer fails:</strong> For Desktop, make sure QZ Tray is installed and running in your system tray. For Android, ensure you are running inside the native Capacitor app and Bluetooth is enabled.</li>
