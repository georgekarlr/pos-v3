...
import { Mail, Lock, AlertCircle, Eye, EyeOff, Sparkles, HelpCircle, WifiOff } from 'lucide-react'
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-800/80 text-xs mt-0.5">
                    Authentication requires an internet connection. Please reconnect to sign in.
                  </p>
                </div>
              </div>
            </div>
