...
export const ZReadingDisplay: React.FC<ZReadingDisplayProps> = ({ report, businessSettings }) => {
  return (
    <div id="z-reading-printout" className="receipt-paper bg-white text-gray-900 mx-auto border border-gray-200 rounded-lg shadow-inner py-3" style={{ width: 320, fontSize: '9px' }}>
      <div className="font-mono text-xs whitespace-pre px-4 py-2 leading-relaxed select-all">
